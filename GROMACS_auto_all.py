...
for i in dirlist:
    ...
    os.mkdir('/home/xov/IDPs/prepfiles/' + str(fname)); 
    homepath = ('/home/xov/IDPs/prepfiles/' + str(fname));
    
    os.mkdir(str(homepath) + '/' + str(fname) + 'amber03');
    path1 = (str(homepath) + '/' + str(fname) + 'amber03');    
    ...
    os.mkdir(str(homepath) + '/' + str(fname) + 'amber99');
    path2 = (str(homepath) + '/' + str(fname) + 'amber99')
    ...
    os.mkdir(str(homepath) + '/' + str(fname) + 'amber99sb');
    path3 = (str(homepath) + '/' + str(fname) + 'amber99sb')
    ...
    os.mkdir(str(homepath) + '/' + str(fname) + 'amber99sb-ildn');
    path4 = (str(homepath) + '/' + str(fname) + 'amber99sb-ildn')
    ...
    os.mkdir(str(homepath) + '/' + str(fname) + 'amber99sb-star');
    path5 = (str(homepath) + '/' + str(fname) + 'amber99sb-star')
    ...
    os.mkdir(str(homepath) + '/' + str(fname) + 'amber99sb-star-ildn');
    path6 = (str(homepath) + '/' + str(fname) + 'amber99sb-star-ildn')
    ...
    os.mkdir(str(homepath) + '/' + str(fname) + 'amber99sb-star-ildnp');
    path7 = (str(homepath) + '/' + str(fname) + 'amber99sb-star-ildnp')
    ...
    os.mkdir(str(homepath) + '/' + str(fname) + 'charmm27');
    path8 = (str(homepath) + '/' + str(fname) + 'charmm27')
    ...
    os.mkdir(str(homepath) + '/' + str(fname) + 'gromos43a1');
    path9 = (str(homepath) + '/' + str(fname) + 'gromos43a1')
    ...
    os.mkdir(str(homepath) + '/' + str(fname) + 'gromos43a2');
    path10 = (str(homepath) + '/' +  str(fname) + 'gromos43a2')
    ...
    os.mkdir(str(homepath) + '/' + str(fname) + 'gromos45a3');
    path11 = (str(homepath) + '/' + str(fname) + 'gromos45a3')
    ...
    os.mkdir(str(homepath) + '/' + str(fname) + 'gromos53a5');
    path12 = (str(homepath) + '/' + str(fname) + 'gromos53a5')
    ...
    os.mkdir(str(homepath) + '/' + str(fname) + 'gromos53a6');
    path13 = (str(homepath) + '/' + str(fname) + 'gromos53a6')
    ...
    os.mkdir(str(homepath) + '/' + str(fname) + 'gromos54a7');
    path14 = (str(homepath) + '/' + str(fname) + 'gromos54a7')
    ...
    os.mkdir(str(homepath) + '/' + str(fname) + 'opls');
    path15 = (str(homepath) + '/' + str(fname) + 'opls')
