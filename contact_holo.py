...
u = Universe('/home/xov/mdmx/top_dcd/MDMX_mdm.pdb', '/home/xov/mdmx/top_dcd/mdmh_MDMX.dcd', permissive=False);
...
sel1 = 'resid 26:42' #a2
sel2 = 'resid 68:82' #t3a4 ---this selection goes on y axis.
...
#C12.plot_qavg(filename=('qmatrix_' + str(filetitle))); 
